...
FROM student
WHERE length(student_name) = 9; -- 김 한글자가 3byte이므로 성 + 이름 3글자 모두 조회할 때는 9byte 크기를 조회

/***************
영어와(대소문자) 숫자 : 한 글자당 1byte
특수 문자나 비영어 문자 : 한 글자당 2 ~ 4byte 
한글, 일본, 중국어와 같은 문자 : 한 글자당 3byte
이모지 : 4byte 
***************/
-- byte 길이
-- 
